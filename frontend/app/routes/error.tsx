      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="space-y-4">
          ...
          <button 
            ...
            className="inline-block w-full bg-[rgba(64,47,181,0.1)] text-[#a099d8] font-medium py-3 px-6 rounded-lg border border-[#a099d8] hover:bg-[rgba(64,47,181,0.2)] transition-all duration-200"
          >
            Go Back
          </button>
        </div>
